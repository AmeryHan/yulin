						...
						<form id="form1" name="form1" method="post"
							...
							<table width="80%">
								...
								<tr>
									...
									<td><img src="<%=str %>${map1.stoux }" height="142px"
										alt="" style="width: 136px" /></td>
								</tr>
								...
								<tr>
									...
									<td><select name="pHometown">
											...
											<option value="5">执行会长</option>
											<option value="6">常务副会长</option>
											<option value="3">副会长</option>
											<option value="8">监事长</option>
											<option value="9">监事</option>
											<option value="7">秘书长</option>
											<option value="10">副秘书长</option>
									</select></td>
								</tr>
								<tr>
									<td>&nbsp;&nbsp;&nbsp; 简介：</td>
