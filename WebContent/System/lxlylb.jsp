...
<div id="mainContent">
	<div id="tips">当前位置：<span class="fontColor">老乡留言列表</span></div>
    <div id="mainLeft">
    ...
    <li><a href="${pageContext.request.contextPath}/PersonalSelect.do?plid=2">个人申请审批</a></li>
     ...
     <li><a href="${pageContext.request.contextPath}/PolicySelect.do?pyid=2">管理前线列表</a></li>
        ...
        <li><a href="${pageContext.request.contextPath}/HometownSelect.do?htid=2">家乡信息列表</a></li>
          <li><a href="${pageContext.request.contextPath}/PhotoSelect.do?mbid=2">图片展示</a></li>
...
<td  id="tt" style="text-align:left">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;${map.laoxtime} </td>

 
	  <td align="right"><input type="checkbox" onclick="window.location.href='${pageContext.request.contextPath}/LaoxDel.do?id=${map.laoxid}'; "    ></input></td>
</tr>
</logic:iterate>
</table>
<!-- 
