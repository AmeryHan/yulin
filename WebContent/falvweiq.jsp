...
<div id="mainContent">
	<div id="tips">当前位置：<span class="fontColor">老乡留言</span></div>
    <div id="mainLeft">
    	...
    	<div class="sharp color1">
                ...
                <div class="content">  
                	<h3>老乡留言</h3>
                     ...
                     <div id="ListWrapper">
					 	<form id="lyname" method="get" action="${pageContext.request.contextPath}/LaoxAdd.do">
					<table>
					<tr>
					<td>
					 <textarea type="text" style="text-align:left;" name="laoxcontent"   cols="60"  rows="3"  >
					 </textarea>
					</td>
					</tr>
					<tr>
				...
				<tr>
				<td>&nbsp;&nbsp;	${map.laoxcontent}  </td></tr>
				<tr><td>发布者：游客&nbsp;&nbsp;&nbsp;&nbsp;  时间：${map.laoxtime}</td></tr>
						<tr>
						<td><hr /></td>
						</logic:iterate>
