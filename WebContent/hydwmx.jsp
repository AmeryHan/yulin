...
<div id="mainContent">
	<div id="tips">当前位置：<span class="fontColor">会员单位信息</span></div>
    <div id="mainLeft">
...
<!-- registerbtn       --> 
  ...
  <tr>
    ...
    <tr>
    <td >&nbsp;公司名称：<td><ul><a href="hydwmx.jsp">${map.unitName} </a></ul></td>
 
  </tr>
    <tr>
    <td >&nbsp;公司网址：<td><ul><a href="${map.unitWebsite }">${map.unitWebsite }</a></ul></td>
  ...
  <table>
    ...
    <tr>
	 <td colspan="3"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${map.unitContent }  </td>
  </tr>
