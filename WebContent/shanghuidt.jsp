...
<div id="mainContent">
	<div id="tips">当前位置：<span class="fontColor">商会动态</span></div>
    <div id="mainLeft">
...
<!-- registerbtn       --> 
	...
	<tr id="r1">
	<td  id="t1" style="text-align:left">&nbsp;<a href="${pageContext.request.contextPath}/NewSelOne.do?newid=${map1.newsId }">${map1.newsTitle} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${map1.newsAuthor}</a></td>
