...
<div id="mainContent">
	<div id="tips">当前位置：<span class="fontColor">家乡</span></div>
    <div id="mainLeft">
...
<tr id="r1">
 ...
 <td  id="tt" style="text-align:left"><a href="${pageContext.request.contextPath}/HometownSelectOne.do?id=${map.homeid}"> ${map.hometitle}</a></td>
