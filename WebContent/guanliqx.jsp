...
<div id="mainContent">
	<div id="tips">当前位置：<span class="fontColor">管理前线</span></div>
    <div id="mainLeft">
                	...
                	<h3>管理前线</h3>
                   	  ...
                   	  <ul>
									...
									<logic:iterate id="map2" collection="${requestScope.arr1}">
									      	<li><a href="${pageContext.request.contextPath}/PolicySelOne.do?id=${map2.policyId}">${map2.policyTitle}</a>
									      	<span id="Date">${map2.policyTime}</span></li>
