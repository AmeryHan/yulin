...
<div id="mainContent">
	<div id="tips">当前位置：<span class="fontColor">会员随笔信息发布</span></div>
    <div id="mainLeft">
	   ...
	   <div id="mainRight">
    	<div class="sharp color1">
                ...
                <div class="content">  
                	<h3>会员随笔信息发布</h3>
					<p>
                     <form id="form1" name="form1" method="post" action="${pageContext.request.contextPath}/MemberAdd.do">
                <table width="80%"  >
                 
					   <tr>
                        <td>&nbsp;&nbsp;&nbsp;标题：</td>
                        <td><input class="inputStyle"  name="membertitle"/></td>
                    </tr>
                    <tr>
                        <td> &nbsp;&nbsp;&nbsp;发布人：</td>
                 ...
                 <!-- 
                  ...
                  -->
                    ...
                    <tr>
                        <td>&nbsp;&nbsp;&nbsp;内容：</td>
                        <td >
                            <textarea    name="membercontent"  style="height:250px;" cols="65" rows="50"></textarea>   
                                                </td>
                    </tr>
                    <tr>
