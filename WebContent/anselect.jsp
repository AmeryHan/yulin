...
<div id="notice"><span class="more"><a href="${pageContext.request.contextPath}/AnSelect2.do?anid=1">更多</a></span>
<ul>
	<table>
		<logic:iterate id="map" collection="${requestScope.arr}">
		 
				<tr id="r1">
				<td  id="tt" style="text-align:left"><a href="${pageContext.request.contextPath}/AnSelOne.do?id=${map.anID}">${map.anTitle} </a></td>
				<td style="text-align:right">&nbsp; &nbsp; &nbsp; &nbsp; <span id="Date">${map.anTime}</span></td>
				</tr>
		</logic:iterate>
		<!-- 
				<tr id="r1">
...
<div id="notice"><span class="more"><a
	href="${pageContext.request.contextPath}/NewSelect.do?newid=1">更多</a></span>
<ul>
	<table>
		<logic:iterate id="map1" collection="${requestScope.arr1}">
			<tr id="r1">
				<td id="t1" style="text-align: left">&nbsp;<a href="${pageContext.request.contextPath}/NewSelOne.do?newid=${map1.newsId }">${map1.newsTitle}</a></td>
...
<div id="notice"><span class="more"><a
	href="${pageContext.request.contextPath}/UnitSelect.do?utid=1">更多</a></span>
<div id="personInfo">
<table>
	<tr>
...
<div id="notice"><input type="button" value="" class="personbtn"
...
<div id="notice"><span class="more">
<a href="${pageContext.request.contextPath}/PolicySelect.do?pyid=1">更多</a></span>
<ul>
	<table>
		...
		<tr id="r1">
			<td style="text-align: left" id="t1">
			<a href="${pageContext.request.contextPath}/PolicySelOne.do?id=${map2.policyId}">${map2.policyTitle}</a></td>
			<td style="text-align: right">&nbsp; &nbsp; &nbsp; &nbsp; <span
				id="Date">${map2.policyTime}</span></td>
...
<div id="notice"><span class="more"><a href="${pageContext.request.contextPath}/PersonalSelect.do?plid=1">更多</a></span>
<div id="personInfo">
<table>
	<tr>
		<logic:iterate id="map7" collection="${requestScope.arr7}">
		<td>
			<img src="<%=str %>${map7.ptoux }" width="80" height="100" />
...
<div id="OrgIns1"><span class="more"><a href="${pageContext.request.contextPath}/StructureXS.do">更多</a></span>
<table>
...
<div id="OrgIns2"><span class="more">
<a href="${pageContext.request.contextPath}/MemberSelect.do?mbid=1">更多</a></span>
...
<ul>
	...
	<logic:iterate id="map4" collection="${requestScope.arr4}">
		...
		<tr>
			...
			<td id="t1" style="text-align: left"><a href="${pageContext.request.contextPath}/MemberOne.do?id=${map4.memberid}">
			${map4.membertitle}
			</a></td>
			<td style="text-align: right">&nbsp; &nbsp; &nbsp; &nbsp; <span
				id="Date">${map4.membertime}</span></td>
...
<div id="OrgIns2"><span class="more"><a
	href="${pageContext.request.contextPath}/HometownSelect.do?htid=1">更多</a></span>
<ul>
	<table>
		...
		<tr id="0">
			...
			<td id="t1" style="text-align: left"><a href="${pageContext.request.contextPath}/HometownSelectOne.do?id=${map3.homeid}">${map3.hometitle}
			</a></td>
			<td style="text-align: right">&nbsp; &nbsp; &nbsp; &nbsp; <span
				id="Date">${map3.hometitle}</span></td>
...
<div id="OrgIns1"><span class="more"><a
	href="${pageContext.request.contextPath}/LaoxSelect.do?lxid=1">更多</a></span>
<ul>
	<table>
				...
				<tr id="r1">
				<td >&nbsp;&nbsp;${map5.laoxcontent}	 </td></tr>
				<tr><td> &nbsp;&nbsp;${map5.laoxtime}</td></tr>
						<tr>
						<td><hr /></td>
						</logic:iterate>
	<!-- 
