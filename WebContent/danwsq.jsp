...
<div id="mainContent">
	<div id="tips">当前位置：<span class="fontColor">单位申请</span></div>
    <div id="mainLeft">
    	...
    	<div class="sharp color1">
                ...
                <div class="content">  
                	<h3>单位申请</h3>
                     ...
                     <form id="form1" name="form1" method="post" action="${pageContext.request.contextPath}/UnitAdd.do">
                <table width="80%"  >
                 
					   <tr>
                        <td>&nbsp;&nbsp;&nbsp;公司名称：</td>
                        <td><input class="inputStyle" name="unitName"/></td>
                    </tr>
                    <tr>
                        <td> &nbsp;&nbsp;&nbsp;注册姓名：</td>
                    ...
                    <tr>
					   ...
					   <tr>
                        <td>&nbsp;&nbsp;&nbsp;职务：</td>
                        <td><input class="inputStyle" name="unitPost" /></td>
                    </tr>
                    <tr>
                        <td>&nbsp;&nbsp;&nbsp;电话：</td>
                        <td><input class="inputStyle" name="unitPhone" /></td>
                    </tr>
                    <tr>
                        <td>&nbsp;&nbsp;&nbsp;邮箱：</td>
                        <td><input class="inputStyle"  name="unitMailBox"/></td>
                    </tr>
                    <tr>
                        <td>&nbsp;&nbsp;&nbsp;QQ：</td>
                        <td><input class="inputStyle"  name="unitQQ"/></td>
                    </tr>
                      <tr>
                        <td>&nbsp;&nbsp;&nbsp;msn：</td>
                        <td><input class="inputStyle" name="unitMsn"/></td>
                    </tr>
                    <!-- 
                    <tr>
                        <td >&nbsp;&nbsp;&nbsp;审核状态：</td>
                    ...
                    <tr>
                        <td>&nbsp;&nbsp;&nbsp;公司网址：</td>
                        <td><input class="inputStyle" name="unitWebsite" /></td>
                    </tr>
                 
                    <tr>
                        <td>&nbsp;&nbsp;&nbsp;个人简介：</td>
                        <td >
                            <textarea  class="inputStyle" name="unitContent"  style="height:50px;" cols="3" rows="10"></textarea>                       </td>
                    </tr>
                    <tr>
                      <td height="35" align="right">&nbsp;&nbsp;&nbsp;<input align="middle" class="canselBtn" type="submit" value="注册" /></td>
